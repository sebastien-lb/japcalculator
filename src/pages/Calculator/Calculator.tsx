...
type Props = OwnProps;
type JapState = { [k in string]: { value: number; kcal: number } };

export const CalculatorPage: React.FC<Props> = (props: Props) => {
    const { classes } = props;

    const [values, setValues] = useState<JapState>({});
            ...
            <div className={classes.calculatorContainer}>
                ...
                <div className={classes.calculatorInnerContainer}>
                    ...
                    <div className={classes.buttonContainer}>
                        <Button variant="contained" onClick={sendData(result)} className={classes.resultButton}>
                            {result} Kcal
                        </Button>
                        <Button variant="contained" onClick={clearForm} className={classes.resultButton}>
                            Reset
                        </Button>
                    </div>
                </div>
